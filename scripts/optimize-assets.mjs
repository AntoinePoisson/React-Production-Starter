...
/**
 * Compress images and GLBs under public/assets/. Local only (sharp + gltf-transform).
 * Keeps a .original.{ext} next to each file. Already-done files are skipped.
 *
 * CONFIG / optimizeModel / optimizeImage are also used by the staged hook.
 *
 *   pnpm optimize-assets
 *   node scripts/optimize-assets.mjs models
 *   node scripts/optimize-assets.mjs textures
 */
...
export const CONFIG = {
  ...
  // 82 is fine for photos. A GPU texture gets resampled anyway.
  jpegQuality: 82,
  webpQuality: 82,
