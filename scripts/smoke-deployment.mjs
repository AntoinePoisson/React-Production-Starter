...
/**
 * Fails a deployment when its public HTML, localized route, SEO files or referenced assets are
 * unreachable. Run after the hosting provider has returned the final URL.
 */
