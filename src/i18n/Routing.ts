// `/` and `/en` are both English. `/en` canonicals to `/`. No middleware on a static site.

/**
 * Hardcoded — a static build has no request to guess a timezone from.
 * @public
 */
...
// No trailing slash. Hosts resolve /fr to dist/fr/index.html; /fr/ is just a redirect.
