...
describe('/$locale', () => {
  ...
  it('should have every locale listed for pre-rendering', async () => {
    ...
    // $locale is dynamic — add it to vite.config `pages` or it's missing from the build.
...
describe('/404', () => {
  it('should render the not-found page', () => {
    // Real route so the build emits 404.html (what static hosts serve for unknown paths).
