...
export default defineConfig(({ command, mode }) => {
  ...
  return {
    // TanStack Start derives its router basepath from Vite's public base. One value therefore
    // controls generated chunks and route matching on sub-path hosts such as GitHub Pages.
    base: `${basePath || ''}/`,
